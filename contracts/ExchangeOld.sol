...
contract Exchange is Ownable {
    ...
    event Trade(uint otype, uint64 price, uint256 amountGet, uint256 amountGive, uint256 fee, address userFill, uint256 timestamp);

    function downFee() public onlyOwner {
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            if (sellAmount == 0) {
                ...
                IERC20(tokenA).transfer(o.seller, (o.amount / price) * 100);
                 ...
                 emit Trade(0, price, (price * sellAmount) / 1000 , sellAmount, currentFee, msg.sender, block.timestamp);
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            if (buyAmount == 0) {
                ...
                IERC20(tokenB).transfer(o.seller, (price * o.amount) / 100);
                 ...
                 emit Trade(1, price, o.amount, (price * o.amount) / 1000, currentFee, msg.sender, block.timestamp);
                ...
                emit Trade(1, price, buyAmount, (price * buyAmount) / 1000 , currentFee, msg.sender, block.timestamp);
